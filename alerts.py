    ...
    rows = [
        {
            ...
            "설명": "국내_주식_조회_잔고를 실제로 호출하는 endpoint가 아직 설정되지 않아 미연결 상태",
        },
        {
            "유형": "미국보유 자동조회",
            "상태": ALERT_STATUS["미국보유 자동조회"],
            "설명": "해외_주식_조회_잔고를 실제로 호출하는 endpoint가 아직 설정되지 않아 미연결 상태",
        },
        {
            "유형": "기관수급",
            "상태": ALERT_STATUS["기관수급"],
            "설명": "국내_주식_시세_투자자에서 외국인/기관 순매수 필드를 공식적으로 처리할 수 있으나 실시간 API 연결은 아직 미확인",
        },
        {
            "유형": "쌍끌이",
            "상태": ALERT_STATUS["쌍끌이"],
            "설명": "외국인+기관 동시 순매수 판정 로직은 구현되지만 공식 기관 데이터 연결이 아직 미확인",
        },
        {
            "유형": "미국30분",
            "상태": ALERT_STATUS["미국30분"],
            "설명": "해외_주식_시세_현재가/체결추이 또는 해외_주식_실시간_체결가의 공식 스키마가 확인되지 않아 30분 브리핑 미연결",
        },
        {
            "유형": "GitHub 휴대폰알림",
